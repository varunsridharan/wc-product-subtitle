...
if ( ! class_exists( 'WC_Product_Subtitle_Installer' ) ) {
	/**
	 * Class WC_Product_Subtitle_Installer
	 *
	...
	class WC_Product_Subtitle_Installer {
		...
		private static function is_before_enabled( $data ) {
			return ( ! empty( $data ) && 'before' === $data ) ? true : false;
		}
...
$callbacks = array(
	'4.0' => array( 'WC_Product_Subtitle_Installer', 'upgrade_v4_0' ),
);
$instance  = new \Varunsridharan\WordPress\Plugin_Version_Management( array(
